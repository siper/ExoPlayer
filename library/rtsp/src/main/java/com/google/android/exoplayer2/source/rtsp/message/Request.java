...
public final class Request extends Message {
    ...
    public static class Builder implements Message.Builder {
        ...
        public Builder options() { return setMethod(Method.OPTIONS); }

        public Builder describe() { return setMethod(Method.DESCRIBE); }

        public Builder setup() { return setMethod(Method.SETUP); }

        public Builder play() { return setMethod(Method.PLAY); }

        public Builder pause() { return setMethod(Method.PAUSE); }

        public Builder announce() { return setMethod(Method.ANNOUNCE); }

        public Builder get_parameter() { return setMethod(Method.GET_PARAMETER); }

        public Builder set_parameter() { return setMethod(Method.SET_PARAMETER); }

        public Builder teardown() { return setMethod(Method.TEARDOWN); }

        public Builder record() { return setMethod(Method.RECORD); }
